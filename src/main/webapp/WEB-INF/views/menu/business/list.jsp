...
<div class="write">
	...
	<%-- 그리드타입,리스트타입 선택 --%>
	<div id="viewType">
		<a type="button" href="/business/list?menu=${param.menu}&cate=${param.cate}"><img src="/resources/img/girdtype.png" style="width: 40px; height: 40px;"></a>
		<a type="button" href="/business/listType?menu=${param.menu}&cate=${param.cate}"><img src="/resources/img/listtype2.png" style="width: 32px; height: 40px;"></a>
	</div>
  ...
  <div class="row">
    ...
    <div class="write-container">
 		<div class="write-container-head">
	        ...
	        <a href="/business/view?boardNo=${list.BOARD_NO }&menu=${list.MENU}&cate=${list.CATE}"><div class="title">${list.TITLE }<span style="color: black; font-size: 0.8em;">[${list.cmtCnt}]</span></div></a>

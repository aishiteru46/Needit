...
<div class="write">
	...
	<%-- 그리드타입,리스트타입 선택 --%>
	<div id="viewType">
		<a type="button" href="/business/list?menu=1&cate=1"><img src="/resources/img/girdtype.png" style="width: 40px; height: 40px;"></a>
		<a type="button" href="/business/listType?menu=1&cate=1"><img src="/resources/img/listtype2.png" style="width: 32px; height: 40px;"></a>
	</div>

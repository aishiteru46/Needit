...
<form action="/business/update" method="post" enctype="multipart/form-data">
...
<div class="text-center">
	...
	<a id="rollBack" type="button" href="/business/view?boardNo=${updateBoard.boardNo }&menu=${updateBoard.menu }&cate=${updateBoard.cate}">돌아가기</a>
</div>

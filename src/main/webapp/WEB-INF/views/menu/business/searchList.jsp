...
<div class="write">
	...
	<%-- 그리드타입,리스트타입 선택 --%>
	<div id="viewType">
		<a type="button" href="/business/search/search?selectSub=${param.selectSub}&searchText=${param.searchText}&menu=${param.menu}&cate=${param.cate}"><img src="/resources/img/girdtype.png" style="width: 40px; height: 40px;"></a>

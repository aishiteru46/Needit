	...
	$.ajax({
	    ...
	    success: function (res) {
	        ...
	        for (var i = 0; i < res.commentList.length; i++) {
	            ...
	            if (id != null) {
	            commentListHtml += '	<button type="button" id="cmtReportBtn" class="cmtReportBtn" data-cmtNo="' + res.commentList[i].CMT_NO + '" data-bs-toggle="modal" data-bs-target="#reportModal">';
	            commentListHtml += '신고';
	            commentListHtml += '	</button>';
	            }
	            commentListHtml += '  </div>';

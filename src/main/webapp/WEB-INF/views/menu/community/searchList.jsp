...
<c:if test="${empty list }">
	<c:if test="${param.menu eq 4 && param.cate eq 1 }">
		<div id="communityText1"> 커뮤니티 
			<div id="communityText2">[공지사항]</div>
		</div>
	</c:if>
	<c:if test="${param.menu eq '4' && param.cate eq '2' }">
		<div id="communityText1"> 커뮤니티
			<div id="communityText2">[우리동네 소식]</div>
		</div>
	</c:if>
	<c:if test="${param.menu eq '4' && param.cate eq '3' }">
		<div id="communityText1"> 커뮤니티
			<div id="communityText2">[자유 게시판]</div>
		</div>
	</c:if>
	<c:if test="${param.menu eq '4' && param.cate eq '4' }">
		<div id="communityText1"> 커뮤니티
			<div id="communityText2">[팁 게시판]</div>
		</div>
	</c:if>
...
<c:import url="/WEB-INF/views/layout/paginationSearchListComu.jsp" />

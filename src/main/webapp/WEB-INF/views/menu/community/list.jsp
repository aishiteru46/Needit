...
<c:forEach  var="list" items="${list }" begin="0" end="0">
	<c:if test="${list.MENU eq 4 and list.CATE eq 1 }">
		<h3>공지사항</h3>	
	</c:if>
	<c:if test="${list.MENU eq 4 and list.CATE eq 2 }">
		<h3>우리동네 소식</h3>	
	</c:if>
	<c:if test="${list.MENU eq 4 and list.CATE eq 3 }">
		<h3>자유 게시판</h3>	
	</c:if>
	<c:if test="${list.MENU eq 4 and list.CATE eq 4 }">
		<h3>꿀팁 게시판</h3>	
	</c:if>
</c:forEach>
